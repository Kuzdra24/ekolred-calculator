...
export default async function Dashboard() {
    ...
    if (!session) {
        redirect("/login?callbackUrl=/adminff");
    }

    return (
        <>
            <div className="grid grid-cols-1 gap-4 px-4 mt-8 sm:grid-cols-4 sm:px-8">
                <div className="flex items-center bg-white border rounded-sm overflow-hidden shadow cursor-pointer">
                    ...
                    <div className="px-4 text-gray-700">
                        <h3 className="text-sm tracking-wider">Nowe oferty</h3>
                ...
                <div className="flex items-center bg-white border rounded-sm overflow-hidden shadow">
                    ...
                    <div className="px-4 text-gray-700">
                        <h3 className="text-sm tracking-wider">Niedokończone</h3>
                ...
                <div className="flex items-center bg-white border rounded-sm overflow-hidden shadow">
                    ...
                    <div className="px-4 text-gray-700">
                        <h3 className="text-sm tracking-wider">Wyświetleń strony</h3>
                        <p className="text-3xl">2,394</p>
                    </div>
                </div>
                <div className="flex items-center bg-white border rounded-sm overflow-hidden shadow">
